...
<body>
	...
	<div id="carouselExampleCaptions" class="carousel slide main_type1"
		data-ride="carousel">
...
if(rList != null && r_fList != null){%>
	...
	%>
				<a
					href="<%=request.getContextPath()%>/detail.re?rId=<%=rList.get(1).getrId()%>"
					class="d-block w-100 thumb_goods"
	...
	%>
				...
				<div class="carousel-caption d-none d-md-block R_textbox2">
					<p class="head_txt2 head_txt">제이의 레시피 추천 둘,</p>
					<br>
...
%>
				<a
					href="<%=request.getContextPath()%>/detail.re?rId=<%=rList.get(2).getrId()%>"
					class="d-block w-100 thumb_goods"
...
%>
				...
				<div class="carousel-caption d-none d-md-block R_textbox3">
					<p class="head_txt3 head_txt">제이의 레시피 추천 셋,</p>
					<br>
...
%>
		...
		<div class="sale_item">
			...
			<div class="sale_thumb">
				<a
					href="<%=request.getContextPath()%>/detail.pr?pId=<%=pList.get(0).getpId()%>">

					<img
					src="<%=request.getContextPath()%>/resources/product/<%=pList.get(0).getCateInId()%>/<%=p_fList.get(0).getfName()%>"
			...
			<a
				...
				<p class="p_price p_txt"><%=pList.get(0).getpPrice()%>원
				</p>
			</a>
		</div>
		<div class="sale_item">
			...
			<div class="sale_thumb">
				<a
					href="<%=request.getContextPath()%>/detail.pr?pId=<%=pList.get(1).getpId()%>">

					<img
					src="<%=request.getContextPath()%>/resources/product/<%=pList.get(1).getCateInId()%>/<%=p_fList.get(1).getfName()%>"
					alt="추천상품1" class="thumb_img">
			...
			<a
				...
				<p class="p_price p_txt"><%=pList.get(1).getpPrice()%>원
				</p>
			</a>
		</div>
		<div class="sale_item">
			...
			<div class="sale_thumb">
				<a
					href="<%=request.getContextPath()%>/detail.pr?pId=<%=pList.get(2).getpId()%>">

					<img
					src="<%=request.getContextPath()%>/resources/product/<%=pList.get(2).getCateInId()%>/<%=p_fList.get(2).getfName()%>"
					alt="추천상품1" class="thumb_img">
			...
			<a
				...
				<p class="p_price p_txt"><%=pList.get(2).getpPrice()%>원
				</p>
			</a>
		</div>
		<div class="sale_item">
			...
			<div class="sale_thumb">
				<a
					href="<%=request.getContextPath()%>/detail.pr?pId=<%=pList.get(3).getpId()%>">

					<img
					src="<%=request.getContextPath()%>/resources/product/<%=pList.get(3).getCateInId()%>/<%=p_fList.get(3).getfName()%>"
					alt="추천상품1" class="thumb_img">
			...
			<a
				...
				<p class="p_price p_txt"><%=pList.get(3).getpPrice()%>원
				</p>
			</a>
		</div>
	</div>
	...
	<div class="sale_list">
		...
		<div class="sale_item">
			<div class="sale_thumb">
				<a href="#"> <img
					src="<%=contextPath %>/resources/images/로제파스타.jpg" alt="세일상품1"
					class="thumb_img">
				</a>
			</div>
		...
		<div class="sale_item">
			<div class="sale_thumb">
				<a href="#"> <img
					src="<%=contextPath %>/resources/images/갈비찜.jpg" alt="세일상품1"
					class="thumb_img">
				</a>
			</div>
			<a href="#" class="sale_info">
		...
		<div class="sale_item">
			<div class="sale_thumb">
				<a href="#"> <img
					src="<%=contextPath %>/resources/recipe/r10.jpg" alt="세일상품1"
					class="thumb_img">
				</a>
			</div>
			<a href="#" class="sale_info">
		...
		<div class="sale_item">
			<div class="sale_thumb">
				<a href="#"> <img
					src="<%=contextPath %>/resources/recipe/r14.jpg" alt="세일상품1"
					class="thumb_img">
				</a>
			</div>
			<a href="#" class="sale_info">
	...
	<div class="special_item"
		style="margin: auto; display: block; width: 1050px; height: 600px; border: 1px solid black;">
		<div style="width: 50%; float: left">
			<p
				style="font-size: 35px; font-weight: 900; padding-left: 20px; margin-top: 20px; margin-bottom: 20px;">
				특가중의 특가<br> MARKET J 특가
			</p>

			<div id="newcountdown"
				style="font-size: 30px; font-weight: 200; padding-left: 20px;"></div>
			<div style="font-size: 30px; font-weight: 200; padding-left: 20px;">2019년
				마지막까지 화이팅</div>
		</div>
		<div class="sale_thumb" style="width: 50%; height: 100%; float: left;">
			<a href="#"> <img
				src="<%=contextPath %>/resources/product/2/P39.PNG" alt="세일상품1"
				class="thumb_img" width="100%" height="600px">
			</a>
		</div>
	</div>
